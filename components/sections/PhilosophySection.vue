<template>
  <SectionContainer id="philosophy">
    <SectionHeading
      title="Curated, not commoditized."
      subtitle="We operate differently. Here's what that means in practice."
      centered
    />
    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
      <div
        ...
        :key="i"
        v-reveal="{ delay: i * 80 }"
        class="reveal rounded-lg border border-carbon-border bg-carbon-surface p-6 transition-colors duration-200 hover:border-carbon-border-subtle hover:bg-carbon-surface-hover"
      >
...
const pillars = [
  {
    ...
    title: 'Curated, not on-demand',
    body: "We don't hire when you need someone. Our team is pre-vetted, trained, and ready.",
  },
  {
    ...
    title: 'Selective vetting',
    body: '<1% acceptance rate',
  },
  {
    icon: 'M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244',
    title: 'Long-term ownership',
    body: 'Engineers stay through the full lifecycle',
  },
  {
    icon: 'M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z',
    title: 'Small & focused',
    body: 'Never more than 8–10 people per engagement',
  },
  {
    ...
    body: 'AI agents pair with every engineer. Velocity multiplied. Standards held.',
  },
  {
    icon: 'M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.922-.957 49.682 49.682 0 00-8.574 0 50.745 50.745 0 00-2.922.957m-.161 4.183a50.559 50.559 0 003.366 2.967 49.136 49.136 0 007.518-2.37 50.32 50.32 0 003.366-2.967M12 13.5a3 3 0 100-6 3 3 0 000 6z',
    title: 'Generational force multiplication',
    body: 'The founder trained our top engineers. They trained the rest. We all code the same way—same vigor, quality, and obsession with clean architecture.',
  },
];
</script>
